CREATE SCHEMA IF NOT EXISTS virtualidentity AUTHORIZATION postgres;
 ...
 */
CREATE SEQUENCE IF NOT EXISTS virtualidentity.base_entity_seq
    INCREMENT 1
    START 1
    MINVALUE 1
...
ALTER SEQUENCE virtualidentity.base_entity_seq
    OWNER TO postgres;